    ...
    <div class="container">
        <div class="row">
            ...
            @foreach($consultas as $consulta)
                ...
                <td class="filas"><a href="/editconsult/{{ $consulta -> id }}" class="btn btn-primary d-inline">Editar</a><a href="deleteconsulta/{{$consulta -> id}}" class="btn btn-danger d-inline" style="margin-left: 10px">Eliminar</a></td>
                </tr>
            @endforeach
            </table>
            </div>
